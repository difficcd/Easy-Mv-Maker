...
function BackgroundChips({ fetching, backupProg, toast, setToast }) {
...
function VideoBusyChip({ videoBusy, setVideoBusyBg, videoStopRef }) {
    return (
...
function ErrorBanner({ appError, setAppError }) {
    return (
...
export function Notices({ videoBusy, videoBusyBg, setVideoBusyBg, videoStopRef, backupProg, toast, setToast, appError, setAppError }) {
    return (
        <>
