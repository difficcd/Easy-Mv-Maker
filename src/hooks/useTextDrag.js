 ...
 */
export function useTextDrag({ dispatchCuts, currentCutId, setSelectedText, beginGesture }) {
    ...
    // measureText needs.
    const measureTextBox = (t) => measureTextBoxPure(t, getMeasureCtx());
