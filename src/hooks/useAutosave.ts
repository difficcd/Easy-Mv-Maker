 ...
 */
export function useAutosave({ doc, ready, busy, build, save, delay = 1500 }: { doc: unknown, ready: () => boolean, busy: () => boolean, build: () => Promise<any>, save: (data: any) => Promise<any>, delay?: number }): { savedAt: number | null, error: string | null } {
